...
global launch_bounds(Ktraits::kNThreads, Ktraits::kMinBlocks)
...
void selective_scan_fwd_launch(SSMParamsBase &params, cudaStream_t stream) {
    // Définir kNRows selon vos besoins
            ...
            BOOL_SWITCH(params.is_variable_C, kIsVariableC, [&] {
                BOOL_SWITCH(params.z_ptr != nullptr, kHasZ, [&] {
                    ...
                    if (kSmemSize >= 48 * 1024) {
                        ...
                        #else
                        C10_CUDA_CHECK(cudaFuncSetAttribute((void *) kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, kSmemSize));
